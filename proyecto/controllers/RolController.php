...
class RolController extends Controller
{
    ...
    /**
     * Displays a single RolesForm model.
     * @param int $id ID
     * @return mixed
    ...
    /**
     * Updates an existing RolesForm model.
    ...
    /**
     * Deletes an existing RolesForm model.
    ...
    /**
     * Finds the RolesForm model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return RolesForm the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RolesForm::findOne($id)) !== null) {
            return $model;
        }
